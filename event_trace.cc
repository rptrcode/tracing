...
void TraceEndOnScopeClose::AddEventIfEnabled() {
  ...
  if (*p_data_->category_enabled) {
    TRACE_EVENT_API_ADD_TRACE_EVENT(
        ...
        kNoEventId, kZeroNumArgs, NULL, NULL, NULL, kNoThreshholdBeginId,
        kNoThresholdValue, TRACE_EVENT_FLAG_NONE);
  }
}
...
void TraceEndOnScopeCloseThreshold::AddEventIfEnabled() {
  ...
  if (*p_data_->category_enabled) {
    TRACE_EVENT_API_ADD_TRACE_EVENT(
        TRACE_EVENT_PHASE_END, p_data_->category_enabled, p_data_->name,
        kNoEventId, kZeroNumArgs, NULL, NULL, NULL, p_data_->threshold_begin_id,
        p_data_->threshold, TRACE_EVENT_FLAG_NONE);
  }
}
